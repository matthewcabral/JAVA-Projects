...
CREATE TABLE PDV.T_ACCNT_NUMBER (
	...
	MODIFICATION_NUM NUMBER(10, 0) DEFAULT 0 NOT NULL,                  -- NUMERO DE MODIFICAÇÃO
	DB_LAST_UPD TIMESTAMP DEFAULT SYSDATE,                              -- ULTIMA ATUALIZAÇÃO NO BANCO DE DADOS
	P_NEXT_ACCNT_NUMBER VARCHAR2(50 CHAR) NOT NULL,						-- PROXIMO ACCOUNT NUMBER
...
CREATE TABLE PDV.T_ACCNT_NUMBER (
	...
	MODIFICATION_NUM NUMBER(10, 0) DEFAULT 0 NOT NULL,                  -- NUMERO DE MODIFICAÇÃO
	DB_LAST_UPD TIMESTAMP DEFAULT SYSDATE,                              -- ULTIMA ATUALIZAÇÃO NO BANCO DE DADOS
	P_NEXT_ORDER_NUMBER VARCHAR2(50 CHAR) NOT NULL,						-- PROXIMO ACCOUNT NUMBER
...
CREATE TABLE PDV.T_LANG (
	...
	DB_LAST_UPD TIMESTAMP DEFAULT SYSDATE,                              -- ULTIMA ATUALIZAÇÃO NO BANCO DE DADOS
	LANG_CD VARCHAR2(5 CHAR),
	NAME VARCHAR2(50 CHAR),
	VALUE VARCHAR2(50 CHAR),
	ORDER_BY NUMBER(22, 7),                                             -- ORDEM

	CONSTRAINT pk_lang_id PRIMARY KEY (ROW_ID)
)
