 ...
 */
public class ContactManagementScreen extends javax.swing.JFrame {

    /**
     * Creates new form ContactManagement
     */
    public ContactManagementScreen() {
        initComponents();
    ...
    public String getSelectedContactListId() { return (String) this.tblContactList.getValueAt(this.tblContactList.getSelectedRow(), 0); }
    ...
    public String gettxtContactListFilterValue() { return this.txtContactListFilterValue.getText(); }
    public String gettxtContactMPhone() { return this.txtContactEnterprise.getText(); }
    ...
    public String gettxtContactEnterprise() { return this.txtContactMPhone.getText(); }
    ...
    public String getcbbContactListFilter() { return this.cbbContactListFilter.getSelectedItem().toString(); }
    ...
    public String getcbbContactEmailType() { return this.cbbContactEmailType.getSelectedItem().toString(); }
    ...
    public void cleartxtContactMPhone() { this.txtContactEnterprise.setText(""); this.txtContactEnterprise.paintImmediately(this.txtContactEnterprise.getVisibleRect()); }
    ...
    public void cleartxtContactEnterprise() { this.txtContactMPhone.setText(""); this.txtContactMPhone.paintImmediately(this.txtContactMPhone.getVisibleRect()); }
    ...
    public void settxtContactMPhoneEnabled(boolean status) { this.txtContactEnterprise.setEnabled(status); }
    ...
    public void settxtContactEnterpriseEnabled(boolean status) { this.txtContactMPhone.setEnabled(status); }
    ...
    public boolean istxtContactMPhoneEnabled() { return this.txtContactEnterprise.isEnabled(); }
    ...
    public boolean istxtContactEnterpriseEnabled() { return this.txtContactMPhone.isEnabled(); }
    ...
    public void enableFields(String funcao) {
        switch (funcao){
            ...
            case "CANCELAR":
                ...
                setcbbContactListFilterEnabled(false);
                setcbbCivilStateEnabled(false);
                setcbbDayEnabled(false);
                setcbbDocTypeEnabled(false);
                setcbbMonthEnabled(false);
    ...
    private void initComponents() {
        ...
        PanelContactFormHeaderLayout.setVerticalGroup(
            ...
            .addGroup(PanelContactFormHeaderLayout.createSequentialGroup()
                .addGroup(PanelContactFormHeaderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblContactNameHeader, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        ckbSendPromFlg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ckbSendPromFlgActionPerformed(evt);
            }
        });
        ...
        btnAddSocialMedia.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                btnAddSocialMediaFocusLost(evt);
            }
        });
    ...
    private void btnAddSocialMediaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_btnAddSocialMediaFocusLost
        setFocus("BOTAO_ADD_ENDERECO");
    }//GEN-LAST:event_btnAddSocialMediaFocusLost
    ...
    private void ckbSendPromFlgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ckbSendPromFlgActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ckbSendPromFlgActionPerformed
