...
public class UserManagementScreen extends javax.swing.JFrame {
    ...
    public String getSelectedUserListId() { return (String) this.tblUserList.getValueAt(this.tblUserList.getSelectedRow(), 0); }
    ...
    public String gettxtPass() { return this.txtPass.getText(); }
    public String gettxtPassVerification() { return this.txtPassVerification.getText(); }
    public String gettxtSecQuestion1() { return this.txtSecQuestion1.getText(); }
    public String gettxtSecAnswer1() { return this.txtSecAnswer1.getText(); }
    public String gettxtSecQuestion2() { return this.txtSecQuestion2.getText(); }
    public String gettxtSecAnswer2() { return this.txtSecAnswer2.getText(); }
    public String gettxtSecQuestion3() { return this.txtSecQuestion3.getText(); }
    public String gettxtSecAnswer3() { return this.txtSecAnswer3.getText(); }
    public String gettxtDocNum() { return this.txtDocNum.getText(); }
    public String gettxtName() { return this.txtName.getText(); }
    public String gettxtSurname() { return this.txtSurname.getText(); }
    public String gettxtNickName() { return this.txtNickName.getText(); }
    public String gettxtYear() { return this.txtYear.getText(); }
    public String gettxtBornLocation() { return this.txtBornLocation.getText(); }
    public String gettxtSpouseName() { return this.txtSpouseName.getText(); }
    public String gettxtMotherName() { return this.txtMotherName.getText(); }
    public String gettxtFatherName() { return this.txtFatherName.getText(); }
    public String gettxtRecNum() { return this.txtRecNum.getText(); }
    public String gettxtSerieNum() { return this.txtSerieNum.getText(); }
    public String gettxtEmissor() { return this.txtEmissor.getText(); }
    public String gettxtEmissionDate() { return this.txtEmissionDate.getText(); }
    public String gettxtValidThru() { return this.txtValidThru.getText(); }
    public String gettxtNaturalness() { return this.txtNaturalness.getText(); }
    public String gettxtNationality() { return this.txtNationality.getText(); }
    public String gettxtUserListFilterValue() { return this.txtUserListFilterValue.getText(); }
    public String gettxtContactMPhone() { return this.txtContactMPhone.getText(); }
    public String gettxtContactEmail() { return this.txtContactEmail.getText(); }
    public String gettxtContactPhone() { return this.txtContactPhone.getText(); }
    public String gettxtContactEnterprise() { return this.txtContactEnterprise.getText(); }
    public String gettxtFacebook() { return this.txtFacebook.getText(); }
    public String gettxtInstagram() { return this.txtInstagram.getText(); }
    public String gettxtTwitter() { return this.txtTwitter.getText(); }    
    public String gettxtFullAddress() { return this.txtFullAddress.getText(); }
    
    public String getcbbUserListFilter() { return this.cbbUserListFilter.getSelectedItem().toString(); }
    public String getcbbCivilState() { return this.cbbCivilState.getSelectedItem().toString(); }
    public String getcbbDay() { return this.cbbDay.getSelectedItem().toString(); }
    public String getcbbDocType() { return this.cbbDocType.getSelectedItem().toString(); }
    public String getcbbEmissionUF() { return this.cbbEmissionUF.getSelectedItem().toString(); }
    public String getcbbIdentityType() { return this.cbbIdentityType.getSelectedItem().toString(); }
    public String getcbbMonth() { return this.cbbMonth.getSelectedItem().toString(); }
    public String getcbbPosition() { return this.cbbPosition.getSelectedItem().toString(); }
    public String getcbbSex() { return this.cbbSex.getSelectedItem().toString(); }
    ...
    private void initComponents() {
        ...
        btnEditUser.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ...
        btnNewUser.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ...
        btnSaveUser.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ...
        btnCancelUser.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 10, 1, 10));
        btnCancelUser.setEnabled(false);
        btnCancelUser.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
                            ...
                            .addGroup(PanelFormUserLayout.createSequentialGroup()
                                .addGroup(PanelFormUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PanelFormUserLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(PanelFormUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(cbbPosition, 0, 165, Short.MAX_VALUE)
                                            .addComponent(btnPermitions, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PanelFormUserLayout.createSequentialGroup()
