 ...
 */
public class EncryptDecryptWordClass {

    public EncryptDecryptWordClass() {}
    ...
    public String encryptWord(String word) {
        ...
        System.out.println("Resultado Final: " + wordEncrypted);
    ...
    public String decryptWord(String word) {
        ...
        //System.out.println("Count: " + count);
        System.out.println("Resultado Final: " + wordDecrypted);
