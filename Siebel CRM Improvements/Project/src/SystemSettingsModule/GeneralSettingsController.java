...
public class GeneralSettingsController {
    File file;
    GeneralSettingsScreen genScreen;
    Controller control;
    // Database Variables
    ...
    public GeneralSettingsController(boolean firstSettings) {
        this.firstSettings = firstSettings;
        genScreen = new GeneralSettingsScreen();
    ...
    private boolean saveDbParameters(){
        try{
            ...
            String header = "DRIVER;URL;LOCAL;PORTA;NOME_BANCO;OWNER_BANCO\n";
            if (!path.isEmpty()) {            
